...
var (
	...
	LayerTypePNIOConnectReq               = gopacket.RegisterLayerType(148, gopacket.LayerTypeMetadata{Name: "PNIOConnectReq", Decoder: gopacket.DecodeFunc(decodePNIOConnectReq)})
	LayerTypePNIOReleaseReq               = gopacket.RegisterLayerType(149, gopacket.LayerTypeMetadata{Name: "PNIOReleaseReq", Decoder: gopacket.DecodeFunc(decodePNIOReleaseReq)})
	LayerTypePNIOReadReq                  = gopacket.RegisterLayerType(150, gopacket.LayerTypeMetadata{Name: "PNIOReadReq", Decoder: gopacket.DecodeFunc(decodePNIOReadReq)})
	LayerTypePNIOWriteReq                 = gopacket.RegisterLayerType(151, gopacket.LayerTypeMetadata{Name: "PNIOWriteReq", Decoder: gopacket.DecodeFunc(decodePNIOWriteReq)})
	LayerTypePNIOControlReq               = gopacket.RegisterLayerType(152, gopacket.LayerTypeMetadata{Name: "PNIOControlReq", Decoder: gopacket.DecodeFunc(decodePNIOControlReq)})
	LayerTypePNIOConnectRes               = gopacket.RegisterLayerType(154, gopacket.LayerTypeMetadata{Name: "PNIOConnectRes", Decoder: nil})
	LayerTypePNIOReleaseRes               = gopacket.RegisterLayerType(155, gopacket.LayerTypeMetadata{Name: "PNIOReleaseRes", Decoder: nil})
	LayerTypePNIOReadRes                  = gopacket.RegisterLayerType(156, gopacket.LayerTypeMetadata{Name: "PNIOReadRes", Decoder: nil})
	LayerTypePNIOWriteRes                 = gopacket.RegisterLayerType(157, gopacket.LayerTypeMetadata{Name: "PNIOWriteRes", Decoder: nil})
	LayerTypePNIOControlRes               = gopacket.RegisterLayerType(158, gopacket.LayerTypeMetadata{Name: "PNIOControlRes", Decoder: nil})
	LayerTypePNIOReadImplicitRes          = gopacket.RegisterLayerType(159, gopacket.LayerTypeMetadata{Name: "PNIOReadImplicitRes", Decoder: nil})
	LayerTypeRPC                          = gopacket.RegisterLayerType(160, gopacket.LayerTypeMetadata{Name: "RPC", Decoder: gopacket.DecodeFunc(decodeRPC)})
	LayerTypeRPCEPMapLookupReq            = gopacket.RegisterLayerType(161, gopacket.LayerTypeMetadata{Name: "RPCEPMapLookupReq", Decoder: gopacket.DecodeFunc(decodeRPCEPMapLookupReq)})
	LayerTypeRPCEPMapLookupRes            = gopacket.RegisterLayerType(162, gopacket.LayerTypeMetadata{Name: "RPCEPMapLookupRes", Decoder: nil})
	LayerTypeRPCEPMapLookupFreeReq        = gopacket.RegisterLayerType(163, gopacket.LayerTypeMetadata{Name: "RPCEPMapLookupFreeReq", Decoder: gopacket.DecodeFunc(decodeRPCEPMapLookupFreeReq)})
	LayerTypeRPCEPMapLookupFreeRes        = gopacket.RegisterLayerType(164, gopacket.LayerTypeMetadata{Name: "RPCEPMapLookupFreeRes", Decoder: nil})
)
