...
var (
	...
	LayerTypeProfinet                     = gopacket.RegisterLayerType(800, gopacket.LayerTypeMetadata{Name: "Profinet", Decoder: gopacket.DecodeFunc(decodeProfinet)})
	LayerTypeProfinetDCP                  = gopacket.RegisterLayerType(801, gopacket.LayerTypeMetadata{Name: "ProfinetDCP", Decoder: gopacket.DecodeFunc(decodeProfinetDCP)})
	LayerTypeProfinetRT                   = gopacket.RegisterLayerType(802, gopacket.LayerTypeMetadata{Name: "ProfinetRT", Decoder: gopacket.DecodeFunc(decodeProfinetRT)})
	LayerTypePNIOConnectReq               = gopacket.RegisterLayerType(803, gopacket.LayerTypeMetadata{Name: "PNIOConnectReq", Decoder: gopacket.DecodeFunc(decodePNIOConnectReq)})
	LayerTypePNIOReleaseReq               = gopacket.RegisterLayerType(804, gopacket.LayerTypeMetadata{Name: "PNIOReleaseReq", Decoder: gopacket.DecodeFunc(decodePNIOReleaseReq)})
	LayerTypePNIOReadReq                  = gopacket.RegisterLayerType(805, gopacket.LayerTypeMetadata{Name: "PNIOReadReq", Decoder: gopacket.DecodeFunc(decodePNIOReadReq)})
	LayerTypePNIOWriteReq                 = gopacket.RegisterLayerType(806, gopacket.LayerTypeMetadata{Name: "PNIOWriteReq", Decoder: gopacket.DecodeFunc(decodePNIOWriteReq)})
	LayerTypePNIOControlReq               = gopacket.RegisterLayerType(807, gopacket.LayerTypeMetadata{Name: "PNIOControlReq", Decoder: gopacket.DecodeFunc(decodePNIOControlReq)})
	LayerTypePNIOConnectRes               = gopacket.RegisterLayerType(808, gopacket.LayerTypeMetadata{Name: "PNIOConnectRes", Decoder: nil})
	LayerTypePNIOReleaseRes               = gopacket.RegisterLayerType(809, gopacket.LayerTypeMetadata{Name: "PNIOReleaseRes", Decoder: nil})
	LayerTypePNIOReadRes                  = gopacket.RegisterLayerType(810, gopacket.LayerTypeMetadata{Name: "PNIOReadRes", Decoder: nil})
	LayerTypePNIOWriteRes                 = gopacket.RegisterLayerType(811, gopacket.LayerTypeMetadata{Name: "PNIOWriteRes", Decoder: nil})
	LayerTypePNIOControlRes               = gopacket.RegisterLayerType(812, gopacket.LayerTypeMetadata{Name: "PNIOControlRes", Decoder: nil})
	LayerTypePNIOReadImplicitRes          = gopacket.RegisterLayerType(813, gopacket.LayerTypeMetadata{Name: "PNIOReadImplicitRes", Decoder: nil})
	LayerTypeRPC                          = gopacket.RegisterLayerType(814, gopacket.LayerTypeMetadata{Name: "RPC", Decoder: gopacket.DecodeFunc(decodeRPC)})
	LayerTypeRPCEPMapLookupReq            = gopacket.RegisterLayerType(815, gopacket.LayerTypeMetadata{Name: "RPCEPMapLookupReq", Decoder: gopacket.DecodeFunc(decodeRPCEPMapLookupReq)})
	LayerTypeRPCEPMapLookupRes            = gopacket.RegisterLayerType(816, gopacket.LayerTypeMetadata{Name: "RPCEPMapLookupRes", Decoder: nil})
	LayerTypeRPCEPMapLookupFreeReq        = gopacket.RegisterLayerType(817, gopacket.LayerTypeMetadata{Name: "RPCEPMapLookupFreeReq", Decoder: gopacket.DecodeFunc(decodeRPCEPMapLookupFreeReq)})
	LayerTypeRPCEPMapLookupFreeRes        = gopacket.RegisterLayerType(818, gopacket.LayerTypeMetadata{Name: "RPCEPMapLookupFreeRes", Decoder: nil})
)
