...
var (
	...
	LayerTypeProfinet                     = gopacket.RegisterLayerType(1337, gopacket.LayerTypeMetadata{Name: "Profinet", Decoder: gopacket.DecodeFunc(decodeProfinet)})
	LayerTypeProfinetDCP                  = gopacket.RegisterLayerType(1338, gopacket.LayerTypeMetadata{Name: "ProfinetDCP", Decoder: gopacket.DecodeFunc(decodeProfinetDCP)})
	LayerTypeProfinetRT                   = gopacket.RegisterLayerType(1339, gopacket.LayerTypeMetadata{Name: "ProfinetRT", Decoder: gopacket.DecodeFunc(decodeProfinetRT)})
	LayerTypePNIOConnectReq               = gopacket.RegisterLayerType(1340, gopacket.LayerTypeMetadata{Name: "PNIOConnectReq", Decoder: gopacket.DecodeFunc(decodePNIOConnectReq)})
	LayerTypePNIOReleaseReq               = gopacket.RegisterLayerType(1341, gopacket.LayerTypeMetadata{Name: "PNIOReleaseReq", Decoder: gopacket.DecodeFunc(decodePNIOReleaseReq)})
	LayerTypePNIOReadReq                  = gopacket.RegisterLayerType(1342, gopacket.LayerTypeMetadata{Name: "PNIOReadReq", Decoder: gopacket.DecodeFunc(decodePNIOReadReq)})
	LayerTypePNIOWriteReq                 = gopacket.RegisterLayerType(1343, gopacket.LayerTypeMetadata{Name: "PNIOWriteReq", Decoder: gopacket.DecodeFunc(decodePNIOWriteReq)})
	LayerTypePNIOControlReq               = gopacket.RegisterLayerType(1344, gopacket.LayerTypeMetadata{Name: "PNIOControlReq", Decoder: gopacket.DecodeFunc(decodePNIOControlReq)})
	LayerTypePNIOConnectRes               = gopacket.RegisterLayerType(1345, gopacket.LayerTypeMetadata{Name: "PNIOConnectRes", Decoder: nil})
	LayerTypePNIOReleaseRes               = gopacket.RegisterLayerType(1346, gopacket.LayerTypeMetadata{Name: "PNIOReleaseRes", Decoder: nil})
	LayerTypePNIOReadRes                  = gopacket.RegisterLayerType(1347, gopacket.LayerTypeMetadata{Name: "PNIOReadRes", Decoder: nil})
	LayerTypePNIOWriteRes                 = gopacket.RegisterLayerType(1348, gopacket.LayerTypeMetadata{Name: "PNIOWriteRes", Decoder: nil})
	LayerTypePNIOControlRes               = gopacket.RegisterLayerType(1349, gopacket.LayerTypeMetadata{Name: "PNIOControlRes", Decoder: nil})
	LayerTypePNIOReadImplicitRes          = gopacket.RegisterLayerType(1350, gopacket.LayerTypeMetadata{Name: "PNIOReadImplicitRes", Decoder: nil})
	LayerTypeRPC                          = gopacket.RegisterLayerType(1351, gopacket.LayerTypeMetadata{Name: "RPC", Decoder: gopacket.DecodeFunc(decodeRPC)})
	LayerTypeRPCEPMapLookupReq            = gopacket.RegisterLayerType(1352, gopacket.LayerTypeMetadata{Name: "RPCEPMapLookupReq", Decoder: gopacket.DecodeFunc(decodeRPCEPMapLookupReq)})
	LayerTypeRPCEPMapLookupRes            = gopacket.RegisterLayerType(1353, gopacket.LayerTypeMetadata{Name: "RPCEPMapLookupRes", Decoder: nil})
	LayerTypeRPCEPMapLookupFreeReq        = gopacket.RegisterLayerType(1354, gopacket.LayerTypeMetadata{Name: "RPCEPMapLookupFreeReq", Decoder: gopacket.DecodeFunc(decodeRPCEPMapLookupFreeReq)})
	LayerTypeRPCEPMapLookupFreeRes        = gopacket.RegisterLayerType(1355, gopacket.LayerTypeMetadata{Name: "RPCEPMapLookupFreeRes", Decoder: nil})
)
